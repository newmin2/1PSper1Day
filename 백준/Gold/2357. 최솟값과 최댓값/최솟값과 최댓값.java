...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        for(int i=0;i<Integer.parseInt(info[1]);i++){
            ...
            sb.append(st.findMin(1,1,arr.length-1,Integer.parseInt(mInfo[0]),Integer.parseInt(mInfo[1]))).append(" ").append(st.findMax(1,1,arr.length-1,Integer.parseInt(mInfo[0]),Integer.parseInt(mInfo[1]))).append('\n');
        }
